		...
		<form:form action="signUp" method="post" modelAttribute="signUpUserVo">
			...
			<div class="login-fields">
				...
				<div class="field">
					...
					<input type="text" id="name" name="name" value="<c:out value="${signUpUserVo.name}" />" placeholder="昵称" class="login username-field" required />
                ...
                <div class="field">
					...
					<input type="email" id="email" name="email" value="<c:out value="${signUpUserVo.email}" />" placeholder="邮箱" class="login email-field" required />
				...
				<div class="field">
					...
					<input type="password" id="password" name="password" value="<c:out value="${signUpUserVo.password}" />" placeholder="密码" class="login password-field" required />
				...
				<div class="field">
					...
					<input type="password" id="passwordRe" name="passwordRe" value="<c:out value="${signUpUserVo.passwordRe}" />" placeholder="确认密码" class="login password-field" required />
