...
var marka = new google.maps.MarkerImage(
  "<c:url value='/resources/css/css/images/marker-images/image.png'/>",
  new google.maps.Size(59,50),
  new google.maps.Point(0,0),
  new google.maps.Point(30,50)
);
var marka2 = new google.maps.MarkerImage(
  "<c:url value='/resources/css/css/images/marker-images/bauhause.png'/>",
  new google.maps.Size(59,50),
  new google.maps.Point(0,0),
  new google.maps.Point(30,50)
);
...
var list = [
  { lat: 39.91029584638212, 
    ...
    data: { 
      ...
      logo: "mediamarkt.png",
      brosurID:141, 
      brosur: "<c:url value='/resources/css/css/images/noBrochure.png'/>" 
    }, 
    options: { 
      icon: marka
    } 
